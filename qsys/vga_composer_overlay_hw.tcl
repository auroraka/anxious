...
# Sat Aug 27 00:36:53 GMT+08:00 2016
# DO NOT MODIFY


# 
# vga_composer_overlay "VGA Composer with Overlay" v1.0
#  2016.08.27.00:36:53
# 
# 
...
# 
# module vga_composer_overlay
# 
set_module_property DESCRIPTION ""
set_module_property NAME vga_composer_overlay
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME "VGA Composer with Overlay"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL vga_composer_overlay
...
add_fileset_file vga_composer_overlay.vhd VHDL PATH src/vga_composer_overlay.vhd TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL vga_composer_overlay
...
add_fileset_file vga_controller.vhd VHDL PATH src/vga_controller.vhd
add_fileset_file mm_read_buffer_addr.vhd VHDL PATH src/mm_read_buffer_addr.vhd
add_fileset_file vga_composer_overlay.vhd VHDL PATH src/vga_composer_overlay.vhd

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL vga_composer_overlay
...
add_parameter OVERLAY_BANK STD_LOGIC_VECTOR 2
set_parameter_property OVERLAY_BANK DEFAULT_VALUE 2
set_parameter_property OVERLAY_BANK DISPLAY_NAME OVERLAY_BANK
set_parameter_property OVERLAY_BANK TYPE STD_LOGIC_VECTOR
set_parameter_property OVERLAY_BANK UNITS None
set_parameter_property OVERLAY_BANK ALLOWED_RANGES 0:3
set_parameter_property OVERLAY_BANK HDL_PARAMETER true
...
# 
# connection point avalon_master_overlay
# 
add_interface avalon_master_overlay avalon start
set_interface_property avalon_master_overlay addressUnits SYMBOLS
set_interface_property avalon_master_overlay associatedClock clock
set_interface_property avalon_master_overlay associatedReset reset
set_interface_property avalon_master_overlay bitsPerSymbol 8
set_interface_property avalon_master_overlay burstOnBurstBoundariesOnly false
set_interface_property avalon_master_overlay burstcountUnits WORDS
set_interface_property avalon_master_overlay doStreamReads false
set_interface_property avalon_master_overlay doStreamWrites false
set_interface_property avalon_master_overlay holdTime 0
set_interface_property avalon_master_overlay linewrapBursts false
set_interface_property avalon_master_overlay maximumPendingReadTransactions 0
set_interface_property avalon_master_overlay maximumPendingWriteTransactions 0
set_interface_property avalon_master_overlay readLatency 0
set_interface_property avalon_master_overlay readWaitTime 1
set_interface_property avalon_master_overlay setupTime 0
set_interface_property avalon_master_overlay timingUnits Cycles
set_interface_property avalon_master_overlay writeWaitTime 0
set_interface_property avalon_master_overlay ENABLED true
set_interface_property avalon_master_overlay EXPORT_OF ""
set_interface_property avalon_master_overlay PORT_NAME_MAP ""
set_interface_property avalon_master_overlay CMSIS_SVD_VARIABLES ""
set_interface_property avalon_master_overlay SVD_ADDRESS_GROUP ""

add_interface_port avalon_master_overlay overlay_address address Output addr_width
add_interface_port avalon_master_overlay overlay_read read Output 1
add_interface_port avalon_master_overlay overlay_readdata readdata Input data_width
add_interface_port avalon_master_overlay overlay_waitrequest waitrequest Input 1
add_interface_port avalon_master_overlay overlay_readdatavalid readdatavalid Input 1
add_interface_port avalon_master_overlay overlay_lock lock Output 1
...
# 
# connection point overlay_buffer
# 
add_interface overlay_buffer conduit end
set_interface_property overlay_buffer associatedClock clock
set_interface_property overlay_buffer associatedReset ""
set_interface_property overlay_buffer ENABLED true
set_interface_property overlay_buffer EXPORT_OF ""
set_interface_property overlay_buffer PORT_NAME_MAP ""
set_interface_property overlay_buffer CMSIS_SVD_VARIABLES ""
set_interface_property overlay_buffer SVD_ADDRESS_GROUP ""

add_interface_port overlay_buffer overlay_buffer_port buffer_port Input 2
add_interface_port overlay_buffer overlay_vsync_out buffer_vsync Output 1
