...
#define MEMORY_SIZE 32768
	...
	#define RECOG_PORT_PIO RECOG_BUFFER_PORT_PIO_0_BASE
	#define RECOG_VSYNC_PIO RECOG_VSYNC_PIO_0_BASE
#else
	#define RECOG_MEMORY RECOG_MEMORY_1_BASE
	#define RECOG_PORT_PIO RECOG_BUFFER_PORT_PIO_1_BASE
	#define RECOG_VSYNC_PIO RECOG_VSYNC_PIO_1_BASE
#endif
