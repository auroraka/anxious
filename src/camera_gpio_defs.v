...
`define CAM_SIOC_1 GPIO[0]
`define CAM_SIOD_1 GPIO[1]
`define CAM_VSYNC_1 GPIO[2]
`define CAM_HREF_1 GPIO[3]
`define CAM_PCLK_1 GPIO[4]
`define CAM_XCLK_1 GPIO[5]
`define CAM_DIN_1 GPIO[6:13]
`define CAM_RESET_1 GPIO[14]
`define CAM_PWDN_1 GPIO[15]
